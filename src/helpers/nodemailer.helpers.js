...
const urlActual = "http://127.0.0.1:8080/"; // No tocar
const urlProduction = "http://127.0.0.1:8080/";
const port = 8080;
...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'ovejero.gustavo92@gmail.com',
        pass: 'Cyg190921',
    },
});
...
export const sendWellcomeUser = async (usermail) => {
    try {
        ...
        const mailOptions = {
            from: 'Ventas Lonne Open <soi.gustavo19@gmail.com>',
            to: usermail,
